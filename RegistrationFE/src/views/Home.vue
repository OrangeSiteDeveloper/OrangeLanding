<template>
  <div>
    ...
    <div class="overlays-box">
      <h1 style="background: grey">报名流程！！！（此对话框可以可以向下滑动）</h1>
      <div>
        <video
          id="videoOne"
    ...
    <div>
      <div>
        ...
        <div class="text--primary summer-box">
          ...
          <p>此刻，你或许坐在椅上，激战峡谷；</p>
          <p>或许躺在床上，追随月光……</p>
          <p>有时就着漫天朝霞，憧憬未来的大学时光，却不由想起五月的阳光，黯然神伤。</p>
          <p>
    ...
    <span style="display: inline-block; width: 40%">
      ...
      <div>
        ...
        <div v-for="(slide, i) in slides" :key="i">
          <img :lazy-src="slide.lazysrc" :src="slide.src" />
        </div>
      </div>
    ...
    <div style="text-align: center">
      ...
      >
        ...
        <div v-for="(item, i) in items" :key="i" cols="12">{{ item }}</div>
      </span>
      <span style="width: 100px; height: 600px; display: inline-block"></span>
      <span
        style="
          width: 500px;
          height: 600px;
        ...
        "
      >
        <div v-for="card in cards" :key="card.title" :cols="card.flex">{{ card }}</div>
      </span>
    </div>
  </div>
</template>
